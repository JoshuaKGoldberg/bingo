...
<PackageManagers type="dlx" pkg="create-typescript-app@beta" />
...
<PackageManagers
	...
	pkg="create-typescript-app@beta"
	type="dlx"
/>
...
<PackageManagers type="dlx" pkg="create-typescript-app@beta" args="--help" />
...
<PackageManagers type="dlx" pkg="create-typescript-app@beta" args="--offline" />
...
<PackageManagers type="dlx" pkg="create-typescript-app@beta" args="--version" />
