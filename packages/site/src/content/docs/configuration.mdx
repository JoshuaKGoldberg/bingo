...
For example, this configuration keeps a repository up-to-date with [`create-example`](https://github.com/bingo-examples/create-example):
...
Running `npx create-typescript-app@beta` in a repository with that configuration file would be the equivalent of running `npx create-typescript-app@beta --preset everything`.
...
Running `npx create-typescript-app@beta` in a repository with that configuration file would be the equivalent of running `npx create-typescript-app@beta --preset everything`, except it would not apply any CSpell-related files or scripts.
