...
- Bases often need data to be shared between multiple -even many- different Options.
  ...
  wrapped in a caching [`take`](https://www.create.bingo/build/details/contexts/#input-take), then used as needed across any number of Options.
...
See the [`create-example` Base `prepare()` implementation](https://github.com/JoshuaKGoldberg/create-example/blob/c6714eeb02a5106eb5e4e4694f1e8b590444030d/src/base.ts#L138) (TODO: FIX LINK once it exists 😄) for an example of values used across Options.
